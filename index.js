...
const os = require('os') 
// API KEY
const vhtearkey = 'BeliGoblokBetakMulu'// GET IN https://api.vhtear.com/
const lolkey = 'Ninochan' // get in lolhuman.herokuapp.com
const xteamkey = 'c81b3345e477a0c7' // GET IN xteam
const apiKey = 'barbarapih' // get in https://mhankbarbar.tech/api
...
const leyskey = 'demo' //apikey leyscoders
	  ...
	  try {
			...
			mess = {
				...
				only: {
					...
					premium: '*Maaf! Command ini khusus untuk premium saja.*',
...
NOTE : *_Limit direset pada pukul 05:00 WIB_*`)
	...
	cron.schedule('0 5 * * *', () => {
		...
		nino.sendMessage(from, daftarimg, image, {quoted: mek, caption: captionnya})
			...
			if (isCmd && !isPrem && !isOwner) msgFilter.addFilter(from)
...
case 'reset':
                ...
                break
case 'limit':
if (isOwner || isPrem) return reply(`「 *LIMIT COUNT* 」
